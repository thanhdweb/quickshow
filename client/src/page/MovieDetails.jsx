...
const MovieDetails = () => {
  ...
  // Get show details from dummy data
  const getShow = async () => {
    try {
      ...
      <div className='flex flex-col md:flex-row gap-8 max-w-6xl mx-auto'>
        ...
        <div className='relative flex flex-col gap-3'>
          ...
          <div className='flex item-center flex-wrap gap-4 mt-4'>
            ...
            <button onClick={handleFavorite} className='bg-gray-700 p-3 rounded-full transition cursor-pointer active:scale-95'>
        ...
        <div className='flex items-center gap-4 w-max px-4'>
          {
            show.movie.casts.slice(0, 12).map((cast, index) => (
              <div key={index} className='flex flex-col items-center text-center'>
                <img src={image_base_url + cast.profile_path} alt="avatar" className='rounded-full h-20 md:h-20 aspect-square object-cover' />
